public class Report
{
    ...
    public Report(long Report_id, long UTC_Date_Report, bool Is_Fixed,long Problem_Category_id, long Reported_District_id, long? Base_Account_id)
    {
    ...
    public Report(bool Is_Fixed, long Problem_Category_id, long Reported_District_id, long? Base_Account_id)
    {
        this.IsFixed = Is_Fixed;
        this.ProblemCategoryId = (int)Problem_Category_id;
        this.ReportedDistrictId = (int)Reported_District_id;
